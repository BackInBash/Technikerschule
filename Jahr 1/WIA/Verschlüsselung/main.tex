...
\ctparttext{Verschlüsselung kann aus verschiedenen Gründen sinnvoll sein: Auf einem gemeinsam genutzten Computer kann sie Daten für die Mitbenutzer unlesbar machen. Gleiches gilt für Personen, die sich unberechtigt Zugang zu Ihrem Computer verschaffen. Informationen auf mobilen Geräten wie Notebooks und USB-Speichermedien geraten nicht in falsche Hände, wenn das Gerät gestohlen wird oder verloren geht und die Daten darauf verschlüsselt sind.\footnote{\url{https://www.bsi-fuer-buerger.de/BSIFB/DE/Empfehlungen/Verschluesselung/Datenverschluesselung/datenverschluesselung_node.html}}} % Text on the Part 1 page describing  the content in Part 1

\part{Einführung in die Kryptografie} % First part of the thesis
...
\ctparttext{In der asymmetrischen Kryptografie arbeitet man nicht mit einem einzigen Schlüssel, sondern mit einem Schlüsselpaar. Bestehend aus einem öffentlichen und einem privaten Schlüssel. Man bezeichnet diese Verfahren als asymmetrische Verfahren oder Public-Key-Verfahren.\footnote{\url{https://www.elektronik-kompendium.de/sites/net/1910111.htm}}} % Text on the Part 2 page describing the content in Part 2

\part{Asymmetrische Kryptografie} % Second part of the thesis
...
%\include{Chapters/Chapter04} % Appendix A
