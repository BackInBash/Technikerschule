 ...
 */
public class KelvinGUI extends javax.swing.JFrame implements PropertyChangeListener {

    Thermometer temperatur;

    public KelvinGUI(Thermometer temperatur) {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldKelvin, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
  ...
  private void jButtonHochActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHochActionPerformed
      this.temperatur.setKelvin(temperatur.getKelvin() + 1);
  ...
  private void jButtonUebernehmenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUebernehmenActionPerformed
      this.temperatur.setKelvin(Double.parseDouble(jTextFieldKelvin.getText()));
  }//GEN-LAST:event_jButtonUebernehmenActionPerformed

    @Override
    public void propertyChange(PropertyChangeEvent arg0) {
        if (arg0.getPropertyName().equalsIgnoreCase("Temperatur")) {
            jTextFieldKelvin.setText(String.format("%.2f", temperatur.getKelvin()));
        }
    }
